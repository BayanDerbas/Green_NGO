...
class MonitoringProjectPage extends StatelessWidget {
  final int projectId;

  MonitoringProjectPage({super.key, required this.projectId});

  final controller = Get.find<MonitoringProjectController>();
